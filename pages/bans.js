                ...
                <div className="col-6 col-md-6">
                  <LazyLoad offset={50}>
                    <picture>
                      ...
                      <img layout="fill" alt="Introduction" src="https://res.cloudinary.com/xianmalik/image/upload/w_540,h_450,c_fill,f_auto,q_auto/v1589059497/UltraCraft/uc_introduction.jp2" />
                    </picture>
                  </LazyLoad>
                </div>
                <div className="col-6 col-md-6">
