        ...
        <div className="page-wrapper">
          ...
          <section className="page-title">
            <picture className="image-bg">
              ...
              <Image layout="fill" src="https://res.cloudinary.com/xianmalik/image/upload/c_fill,f_auto,q_auto/v1589143340/UltraCraft/uc_nether.jpg" className="image-bg" alt="Ultracraft Nether" />
            </picture>
            ...
            <picture className="dividerBottom">
              ...
              <Image layout="fill" alt="Divider" className="dividerBottom" src="https://res.cloudinary.com/xianmalik/image/upload/w_1871,h_95,c_fill,f_auto,q_auto/v1589138371/UltraCraft/Borders/header1.png" />
            </picture>
          </section>
          ...
          <section id="Section2">
                ...
                <div className="col-6 col-md-6">
                  <LazyLoad offset={50}>
                    <picture>
                      ...
                      <Image layout="fill" alt="Introduction" src="https://res.cloudinary.com/xianmalik/image/upload/w_540,h_450,c_fill,f_auto,q_auto/v1589059497/UltraCraft/uc_introduction.jp2" />
                    </picture>
                  </LazyLoad>
                </div>
                <div className="col-6 col-md-6">
            ...
            <picture className="dividerBottom">
              ...
              <Image layout="fill" alt="Divider" className="dividerBottom" src="https://res.cloudinary.com/xianmalik/image/upload/w_1871,h_95,c_fill,f_auto,q_auto/v1589138371/UltraCraft/Borders/top_dark.png" />
            </picture>
          </section>
          <Footer />
        </div>
