  ...
  render() {
    ...
    return (
      ...
      <picture className="dividerTop">
        ...
        <img className="dividerTop" src="https://res.cloudinary.com/xianmalik/image/upload/w_1871,h_95,c_fill,f_auto,q_auto:eco/v1589138371/UltraCraft/Borders/bottom.png" alt="Divider" />
      </picture>
        ...
        <picture className="dividerBottom">
          ...
          <img className="dividerBottom" src="https://res.cloudinary.com/xianmalik/image/upload/w_1871,h_95,c_fill,f_auto,q_auto:eco/v1589138371/UltraCraft/Borders/header1.png" alt="Divider" />
        </picture>
      </a>
    )
  }
