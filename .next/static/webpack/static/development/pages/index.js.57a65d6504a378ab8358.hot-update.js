...
var HomePage = /*#__PURE__*/function (_React$Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(HomePage, [{
    ...
    value: function handleIpCopy(e) {
      var el = document.querySelectorAll(".server-ip");
      var t = el.innerHtml;
      navigator.clipboard.writeText(this.state.ip);
      el.innerHTML = "<span class='extrapad'>IP Copied!</span>";
      setTimeout(function () {
        el.innterHtml = t;
      }, 800);
    }
    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        onClick: function onClick() {
          return _this3.handleIpCopy();
        },
        dangerouslySetInnerHTML: this.state.ipCopyText,
        __self: this,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 59,
...
//# sourceMappingURL=index.js.57a65d6504a378ab8358.hot-update.js.map